...
ALTER TABLE feeds
    ...
    ADD CONSTRAINT fk_feeds_weather FOREIGN KEY (weather_id) REFERENCES weathers(id) ON DELETE CASCADE;

ALTER TABLE feed_comment
    ADD CONSTRAINT fk_feed_comment_feed FOREIGN KEY (feed_id) REFERENCES feeds(id) ON DELETE CASCADE,
    ADD CONSTRAINT fk_feed_comment_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;
...
ALTER TABLE clothes_attributes
    ...
    ADD CONSTRAINT fk_clothes_attributes_definition FOREIGN KEY (definition_id) REFERENCES attributes(id) ON DELETE CASCADE;

ALTER TABLE feed_clothes
    ADD CONSTRAINT fk_feed_clothes_feed FOREIGN KEY (feed_id) REFERENCES feeds(id) ON DELETE CASCADE,
    ADD CONSTRAINT fk_feed_clothes_clothes FOREIGN KEY (clothes_id) REFERENCES clothes(id) ON DELETE CASCADE;
...
ALTER TABLE feed_likes
    ...
    ADD CONSTRAINT fk_feed_likes_feed FOREIGN KEY (feed_id) REFERENCES feeds(id) ON DELETE CASCADE;
...
ALTER TABLE direct_messages
    ...
    ADD CONSTRAINT fk_direct_messages_sender FOREIGN KEY (sender_user_id) REFERENCES users(id) ON DELETE CASCADE;
